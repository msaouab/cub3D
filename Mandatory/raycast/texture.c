...
{
	ray->adress[0] = (int *)mlx_get_data_addr(ray->north_text, &ray->bits_per_pixel, \
	&ray->line_length2, &ray->endian2);
	ray->adress[1] = (int *)mlx_get_data_addr(ray->south_text, &ray->bits_per_pixel, \
	&ray->line_length2, &ray->endian2);
	ray->adress[2] = (int *)mlx_get_data_addr(ray->west_text, &ray->bits_per_pixel, \
	&ray->line_length2, &ray->endian2);
